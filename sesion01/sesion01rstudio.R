...
library(ggplot2)
library(stringr)
resultados2014 = read_delim("C:/Users/Rolando Rojas/Desktop/Código  Aálisis Multivariado/sesion01/data/resultados2014.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE) #insertar datos separados por ,

head(resultados2014) #mostrar datos de resultados2014

resultados2018 = read_delim("C:/Users/Rolando Rojas/Desktop/Código  Aálisis Multivariado/sesion01/data/resultados2018.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE) #insertar datos separados por ,
...
library("dplyr")
library(geojsonsf)
codigohasc = read_excel("C:/Users/Rolando Rojas/Desktop/Código  Aálisis Multivariado/sesion01/data/codigohasc2.xlsx")
View(codigohasc)
...
mapa_resultados(mapa14, pln14, "green", "PLN 2014")
mapa_resultados(mapa14, pln14, "green", "PLN 2014")
mapa_resultados(mapa18, pln18, "green", "PLN 2018")
...
grafico_votos("pln", "green")
grafico_votos("pusc", "red")
grafico_votos("pac", "brown")
grafico_votos("prn", "blue")
grafico_votos("pin", "yellow")
